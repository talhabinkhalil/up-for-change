...
const GettingStarted = () => {
  return (
    <div className="getting-started-text">
      <Images
        src="/gettingStartedText.png"
        extraClass="getting-started-image"
      />
      <div className="getting-started-below-image-text">
        ...
        <div className="getting-started-text">
          <p>
            Up 4 Change is transforming pocket change into <br />
            global change through hassle free giving!
          </p>
        </div>
        <div className='button_div'>
          <button className="signup-button2">GET STARTED</button>
        </div>
      </div>
    </div>
  );
